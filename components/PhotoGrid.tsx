...
const numColumns = 3;
const imageSize = (width - 70) / numColumns; // Dimensione per una griglia 3x3 con spaziatura
...
const PhotoGrid: React.FC<PhotoGridProps> = ({ 
  ...
  // Renderizza ogni foto della griglia
const renderItem = ({ item }: { item: PhotoData }) => (
  ...
  // Renderizza il footer della lista con un indicatore di caricamento
  const renderFooter = () => {
  ...
  return (
    <View style={styles.container}>
        ...
        keyExtractor={(item) => item.id} // Use just the ID which should be unique
